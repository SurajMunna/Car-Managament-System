    ...
    <div class="row"> 
      ...
      <div class="recent-tab">
        <ul class="nav nav-tabs" role="tablist">
          <li role="presentation" class="active"><a href="#resentnewcar" role="tab" data-toggle="tab">Latest Car</a></li>
        </ul>
      </div>
...
<!-- Fun Facts-->
<section class="fun-facts-section"><!-- Dark Overlay-->
...
<!--Testimonial -->
<section class="section-padding testimonial-section parallex-bg"><!-- Dark Overlay-->
  <div class="dark-overlay"></div>
</section>
<!-- /Testimonial--> 
